        ...
        <div className="row justify-content-center">
          <div className="col-12 col-lg-6">
            <div className="dv-header-promo-grey">
              ...
              <p class="description">
                Fast intracity courier delivery service. We make delivery for
                businesses easier
              </p>
              <div className="dv-header-promo-grey__mini-order">
                    ...
                    <form>
                      <div>
                        <Autocomplete
                          ...
                          // sx={{ width: 300 }}
                          renderInput={(params) => (
                            <TextField {...params} label="Pick-up" />
                          )}
                        />
                      </div>
                      ...
                      <div className="cal-btn">
                        <span className="Button_Wrapper_aMYRR">
                          <Button variant="contained">
                            Calculate the price
                          </Button>
                        </span>
                      </div>
                      <p className="LandingMiniFormGlobal_Description_2Vru6">
                        Urgent delivery at no extra cost or commission
                      </p>
                    </form>
                  </div>
                </div>
